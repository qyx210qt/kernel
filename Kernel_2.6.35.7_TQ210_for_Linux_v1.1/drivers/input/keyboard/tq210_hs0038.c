...
static const unsigned int tq210_hs0038_keycode[]={
	...
	166,/*M_STOP*/	115,/*VOLUME+*/	114,KEY_KPENTER,	/*VOLUME-*/
};
...
static const unsigned int tq210_hs0038_keycode_807F[]={
	...
	KEY_TAB,/*TAB*/	KEY_SPACE,	/*SPACE*/	KEY_0,	/*b~d*/
	KEY_END,/*ENDCALL*/	KEY_BACKSPACE,	/*DEL*/		KEY_SEND,	/*CALL*/ 	/*10~e*/
	KEY_MENU,/*MENU*/	KEY_UP,/*UP*/		KEY_BACK,	/*BACK*/	/*11~13*/
	KEY_RIGHT,/*RIGHT*/	KEY_KPENTER,/*DPAD_CENTER*/	KEY_LEFT,/*LEFT*/	/*16~14*/
	KEY_HOME,/*HOME*/	KEY_DOWN,/*DOWN*/	KEY_POWER,	/*POWER*/	/*17~19*/
	KEY_PREVIOUSSONG,/*M_PREV*/	KEY_PLAYCD,/*M_PLAY*/	KEY_NEXTSONG,	/*M_NEXT*/		
	KEY_STOPCD,/*M_STOP*/	KEY_VOLUMEUP,/*VOLUME+*/	KEY_VOLUMEDOWN,	/*VOLUME-*/
...
MODULE_DESCRIPTION("hs0038 Driver");
MODULE_LICENSE("GPL");
