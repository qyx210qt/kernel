...
#elif 1
extern int tq_auto_detect(struct file *file, void *fh, unsigned int idx);

int fimc_s_input(struct file *file, void *fh, unsigned int idx)
{
	return tq_auto_detect(file,fh,idx);
}
#endif
